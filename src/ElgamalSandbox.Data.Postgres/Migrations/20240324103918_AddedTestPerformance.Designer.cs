...
namespace ElgamalSandbox.Data.SqLite.Migrations
{
    ...
    [Migration("20240324103918_AddedTestPerformance")]
    partial class AddedTestPerformance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.PerformanceTest", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_performance_test");

                    b.HasIndex("TaskDescriptionId")
                        .HasDatabaseName("ix_performance_test_task_description_id");

                    b.ToTable("performance_test", "public");
                });
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.PerformanceTest", b =>
                {
                    b.HasOne("ElgamalSandbox.Core.Entities.TaskDescription", "TaskDescription")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_performance_test_task_descriptions_task_description_id");
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.PerformanceTestAttempt", b =>
                {
                    b.HasOne("ElgamalSandbox.Core.Entities.PerformanceTest", "PerformanceTest")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_performance_test_attempt_performance_test_performance_test_id");
