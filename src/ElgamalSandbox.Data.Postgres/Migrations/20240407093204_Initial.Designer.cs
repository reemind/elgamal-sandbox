...
namespace ElgamalSandbox.Data.SqLite.Migrations
{
    ...
    [Migration("20240407093204_Initial")]
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.TaskTest", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_task_tests");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_task_tests_task_id");

                    b.ToTable("task_tests", "public");
                });
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.TaskTestAttemptRelation", b =>
                {
                    ...
                    b.HasKey("AttemptId", "TestId")
                        .HasName("pk_task_test_attempt_relations");

                    b.HasIndex("TestId")
                        .HasDatabaseName("ix_task_test_attempt_relations_test_id");

                    b.ToTable("task_test_attempt_relations", "public");
                });
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.TaskTest", b =>
                {
                    b.HasOne("ElgamalSandbox.Core.Entities.TaskDescription", "Task")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_tests_task_descriptions_task_id");
            ...
            modelBuilder.Entity("ElgamalSandbox.Core.Entities.TaskTestAttemptRelation", b =>
                {
                    b.HasOne("ElgamalSandbox.Core.Entities.TaskAttempt", "Attempt")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_test_attempt_relations_task_attempts_attempt_id");
                    ...
                    b.HasOne("ElgamalSandbox.Core.Entities.TaskTest", "Test")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_task_test_attempt_relations_task_tests_test_id");
